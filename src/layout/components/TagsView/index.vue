  ...
  <div class="tags-view__container">
    <scroll-pane ref="scrollPaneRef" class="tags-view__wrapper" @scroll="handleScroll">
      <router-link
        ...
        :to="(({ path: tag.path, query: tag.query, fullPath: tag.fullPath }) as RouteLocationRaw)"
    ...
    <ul v-show="visible" :style="{ left: left + 'px', top: top + 'px' }" class="tags-view__menu">
      ...
      <li @click="closeOtherTags">
        <svg-icon name="close_other" />
        关闭其它
      </li>
      <li v-if="!isFirstView()" @click="closeLeftTags">
        <svg-icon name="close_left" />
        关闭左侧
      </li>
      <li v-if="!isLastView()" @click="closeRightTags">
        <svg-icon name="close_right" />
        关闭右侧
      </li>
      <li @click="closeAllTags(selectedTag)">
        <svg-icon name="close_all" />
        关闭所有
      </li>
    </ul>
  </div>
...
import { RouteRecordRaw, useRoute, useRouter, RouteLocationRaw } from 'vue-router';
